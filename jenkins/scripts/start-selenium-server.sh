...
java -jar /tmp/selenium-server/selenium-server-standalone-2.48.2.jar -browser "browserName=chrome, version=76.0, platform=MAC" -Dwebdriver.chrome.driver=/tmp/selenium-server/MAC/chromedriver > /tmp/selenium-server.log 2>&1 &
